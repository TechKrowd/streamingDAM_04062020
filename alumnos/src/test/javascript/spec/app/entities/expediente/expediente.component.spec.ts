...
import { ExpedienteComponent } from 'app/entities/expediente/expediente.component';
...
describe('Component Tests', () => {
  describe('Expediente Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.expedientes && comp.expedientes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
